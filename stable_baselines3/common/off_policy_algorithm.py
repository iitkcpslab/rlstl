        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            while not done:
                ...
                if name=="HalfCheetah-v3" and reward_type=="STL":
                    ...
                    reward=rob
                    #print(str(x)+"      "+str(v)+"      "+str(rob))
                                                                    
                elif name=="Hopper-v3" and reward_type=="STL":
                    #print(observation)
                    # = env.state # th := theta
                    #print(infos)
                    #exit()
                    ...
                    reward=rob
                    #print(str(callback.ctr)+" "+str(p)+" "+str(v)+" "+str(z)+"  "+str(a)+"  "+str(rob))
                    #print(str(callback.ctr)+" "+str(p)+"   "+str(z)+"   "+str(rob))
                    ...
                    reward=rob
                    #print(str(callback.ctr)+" "+str(px)+"   "+str(z)+"    "+str(rob))
            
                elif name=="Ant-v3" and reward_type=="STL":
                    #print(observation)
                    # = env.state # th := theta
                    #print(infos)
                    #exit()
                    ...
                    if callback.ctr==0:
                        ...
                        try:
                            ...
                            sys.exit()
                    if sem=="agm":
                        rob = spec.update(callback.ctr, [('px', px/100), ('vx', vx/7),  ('py', py/25), ('z',z)])
                    else:
                        rob = spec.update(callback.ctr, [('px', px), ('vx', vx),  ('py', py), ('z',z)])
                    reward=rob
                    #print(str(callback.ctr)+" "+str(px)+" "+str(z)+" "+str(rob)) 
            
                elif name=="Swimmer-v3" and reward_type=="STL":
                    #print(observation)
                    # = env.state # th := theta
                    #print(infos)
                    #exit()
                    ...
                    if callback.ctr==0:
                        ...
                        if sem=="agm":
                            spec.spec = 'eventually[0,15](vx>0.005) and always[0,20]((abs(a1)<1) and (abs(a2)<1) and (abs(a3)<1))'
                        else:
                            #spec4
                        ...
                        try:
                            ...
                            sys.exit()
                    if sem=="agm":
                        rob = spec.update(callback.ctr, [('px', px/20), ('vx',vx), ('a1', a1), ('a2', a2), ('a3', a3)])
                    else:
                        rob = spec.update(callback.ctr, [('px', px), ('vx',vx), ('a1', a1), ('a2', a2), ('a3', a3)])
                    reward=rob
                    #print(str(callback.ctr)+" "+str(px)+" "+str(z)+" "+str(rob)) 
                elif name=="Humanoid-v3" and reward_type=="STL":
                    #print(observation)
                    # = env.state # th := theta
                    #print(infos)
                    #exit()
                    ...
                    py = infos[0]['y_position']
                    vx = infos[0]['x_velocity']
                    z,xo,yo,zo,wo = new_obs[0][0:5]
                    rs1,rs2,re = new_obs[0][16:19]
                    ls1,ls2,le = new_obs[0][19:22]
                    ...
                    if callback.ctr==0:
                        ...
                        spec.declare_var('z', 'float')
                        spec.declare_var('xo', 'float')
                        spec.declare_var('yo', 'float')
                        spec.declare_var('zo', 'float')
                        spec.declare_var('wo', 'float')
                        spec.declare_var('le', 'float')
